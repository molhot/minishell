...
t_redirect					*tok_to_redirect_f(bool *flag, t_node *node, \
								t_token **tok);
t_redirect					*tok_to_redirect(t_redirect *redirect, \
							t_token **tok);
...
bool						parse_redirect(t_redirect **redirect, \
								t_token **tok);
void						parse_word(t_token **args, t_token *tok, \
								t_token **tok_o);
void						append_tok(t_token **tokens, t_token *tok);
void						ready_redirect_in_out(t_node *node, bool *flag, \
								bool f_content);
bool						at_eof(t_token *tok);
t_node						*new_node(t_node_kind kind);
t_token						*tokdup(t_token *tok);
void						append_tok(t_token **tokens, t_token *tok);
t_redirect					*tok_to_redirect_f(bool *is_first, t_node *node,
								t_token **tok);
t_redirect					*tok_to_redirect_(bool *is_first, t_node *node,
								t_token **tok);
...
void						inout_reconnect(int file_fd, int fd,
								t_command *command);
