...
SRCS	=	tokenizer/tokenizer.c tokenizer/create_token.c\
			...
			exec_func/exec_func.c exec_func/exec_builtin.c exec_func/pipe_func.c exec_func/redirect_file.c expand/export_argsremake.c exec/redirect_utils.c\
			exec_func/exec_absolutepath.c exec_func/exec_utils.c exec_func/stashfd_helper.c exec_func/builtin_exec.c exec_func/redirect_file_utils.c\
